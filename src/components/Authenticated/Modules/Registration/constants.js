...
export const GET_PATIENTLIST = `${path}/GET_PATIENTLIST`;
export const GET_PATIENTLIST_SUCCESS = `${path}/GET_PATIENTLIST_SUCCESS`;
export const GET_PATIENTLIST_FAILURE = `${path}/GET_PATIENTLIST_FAILURE`;

export const ADD_NEW_PATIENT = `${path}/ADD_NEW_PATIENT`;
